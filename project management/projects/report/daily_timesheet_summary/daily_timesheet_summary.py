...
<<<<<<< HEAD
		`tabtimesheets Detail`.activity, `tabtimesheets Detail`.taskname, `tabtimesheets Detail`.projectect,
=======
		`tabtimesheets Detail`.activity_type, `tabtimesheets Detail`.taskname, `tabtimesheets Detail`.project,
